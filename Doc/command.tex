...
\begin{configuration}{Allow redefine}
\options{\longprogramopt{allow-redefine}}
\config{general}{allow-redefine}
\default{False}
allow redefining macros with python implementation. By default,
\var{\renewcommand} does not redefine a command if it has a python
implementation.
\end{configuration}
