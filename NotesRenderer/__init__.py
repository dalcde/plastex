...
class NotesRenderer(BaseRenderer):
    ...
    def parseTemplate(self, f: Path, name: str):
        ...
        try:
            ...
            print('ERROR: %s in template %s in file %s' % (msg, template, filename))
